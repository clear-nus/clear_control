...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_gripper;/home/crslab/clear_control/src/robots/libfranka/build/libfranka.so.0.7.1".split(';') if "-lfranka_gripper;/home/crslab/clear_control/src/robots/libfranka/build/libfranka.so.0.7.1" != "" else []
