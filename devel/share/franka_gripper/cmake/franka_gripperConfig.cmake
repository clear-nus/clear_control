...
if("TRUE" STREQUAL "TRUE")
  set(franka_gripper_SOURCE_PREFIX /home/crslab/clear_control/src/robots/franka_ros/franka_gripper)
  set(franka_gripper_DEVEL_PREFIX /home/crslab/clear_control/devel)
  ...
  set(franka_gripper_INSTALL_PREFIX /home/crslab/clear_control/install)
...
if(NOT "/home/crslab/clear_control/devel/include;/home/crslab/clear_control/src/robots/franka_ros/franka_gripper/include;/home/crslab/clear_control/src/robots/libfranka/include " STREQUAL " ")
  set(franka_gripper_INCLUDE_DIRS "")
  set(_include_dirs "/home/crslab/clear_control/devel/include;/home/crslab/clear_control/src/robots/franka_ros/franka_gripper/include;/home/crslab/clear_control/src/robots/libfranka/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_gripper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/crslab/clear_control/src/robots/franka_ros/franka_gripper/${idir}'.  ${_report}")
    endif()
    _list_append_unique(franka_gripper_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "franka_gripper;/home/crslab/clear_control/src/robots/libfranka/build/libfranka.so.0.7.1")
