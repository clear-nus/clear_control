...
if("TRUE" STREQUAL "TRUE")
  set(franka_example_controllers_SOURCE_PREFIX /home/crslab/clear_control/src/robots/franka_ros/franka_example_controllers)
  set(franka_example_controllers_DEVEL_PREFIX /home/crslab/clear_control/devel)
  ...
  set(franka_example_controllers_INSTALL_PREFIX /home/crslab/clear_control/install)
...
if(NOT "/home/crslab/clear_control/devel/include;/home/crslab/clear_control/src/robots/libfranka/include " STREQUAL " ")
  set(franka_example_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/crslab/clear_control/devel/include;/home/crslab/clear_control/src/robots/libfranka/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_example_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/crslab/clear_control/src/robots/franka_ros/franka_example_controllers/${idir}'.  ${_report}")
    endif()
    _list_append_unique(franka_example_controllers_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "franka_example_controllers;/home/crslab/clear_control/src/robots/libfranka/build/libfranka.so.0.7.1")
