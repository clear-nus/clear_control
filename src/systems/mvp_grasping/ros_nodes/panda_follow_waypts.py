...
class PandaOpenLoopGraspController(object):
    ...
    def _execute_best_grasp2(self):
        ...
        g.pose.orientation = tfh.list_to_quaternion(tft.quaternion_from_euler(0,0,0))


        self.pc.goto_pose_cartesian(g.pose, velocity=0.001)
