...
class PandaGraspController(object):
    ...
    def go(self):
        ...
        self.pc.goto_joints([-0.23783021000715177, -0.19000717517994997, 0.6514598045868603, -2.6000388373318, 0.026065033034355048, 2.4405504589875537, 1.0527662849186195], velocity=0.2)
        rospy.sleep(2)
        self.pc.gripper.set_gripper(0.1, speed=0.03)
