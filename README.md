...
The controller can be used to conduct force-relevant physcial experiments such as cleaning tasks on a whiteboard, where the position of the end-effector has to be manipualted while a normal force is applied to perform the cleaning successfully.
